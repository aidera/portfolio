...
const items: GridItemType[] = [
  { id: 1, title: 'React.js', img: `${baseRoute}assets/images/react.webp` },
  { id: 2, title: 'Next.js', img: `${baseRoute}assets/images/next.webp` },
  { id: 3, title: 'Angular', img: `${baseRoute}assets/images/angular.png` },
  {
    id: 4,
    title: 'Typescript',
    img: `${baseRoute}assets/images/typescript.webp`,
  },
  { id: 5, title: 'Javascript', img: `${baseRoute}assets/images/js.png` },
  { id: 6, title: 'Redux', img: `${baseRoute}assets/images/redux.png` },
  { id: 9, title: 'RxJs', img: `${baseRoute}assets/images/rxjs.png` },
  { id: 7, title: 'NgRx', img: `${baseRoute}assets/images/ngrx.svg` },
  { id: 22, title: 'Three.js', img: `${baseRoute}assets/images/threejs.png` },
  { id: 13, title: 'Node.js', img: `${baseRoute}assets/images/nodejs.png` },
  { id: 18, title: 'Material', img: `${baseRoute}assets/images/material.png` },
  {
    id: 14,
    title: 'Bootstrap',
    img: `${baseRoute}assets/images/bootstrap.webp`,
  },
  { id: 15, title: 'HTML5', img: `${baseRoute}assets/images/html5.png` },
  { id: 16, title: 'CSS3', img: `${baseRoute}assets/images/css.png` },
  { id: 17, title: 'SASS/SCSS', img: `${baseRoute}assets/images/sass.png` },
  { id: 10, title: 'Docker', img: `${baseRoute}assets/images/docker.webp` },
  { id: 12, title: 'Git', img: `${baseRoute}assets/images/git.webp` },
  { id: 11, title: 'Github', img: `${baseRoute}assets/images/github.webp` },
  { id: 19, title: 'RestAPI', img: `${baseRoute}assets/images/restapi.png` },
  { id: 20, title: 'GraphQL', img: `${baseRoute}assets/images/graphql.png` },
  { id: 21, title: 'VS Code', img: `${baseRoute}assets/images/vscode.png` },
  { id: 8, title: 'Figma', img: `${baseRoute}assets/images/figma.webp` },
  { id: 23, title: 'Autodesk Maya', img: `${baseRoute}assets/images/maya.png` },
  { id: 24, title: 'Blender', img: `${baseRoute}assets/images/blender.png` },
  {
    id: 25,
    title: 'Adobe Photoshop',
    img: `${baseRoute}assets/images/photoshop.png`,
  },
  {
    id: 26,
    title: 'Adobe Illustrator',
    img: `${baseRoute}assets/images/illustrator.png`,
  },
  {
    id: 27,
    title: 'Adobe Substance Painter',
    img: `${baseRoute}assets/images/substance.png`,
  },
  { id: 28, title: 'ZBrush', img: `${baseRoute}assets/images/zbrush.png` },
];
  ...
  return (
    <PageWithViewerLayout>
      ...
      <PageWithViewerLayoutViewer menuItems={[<BackToMenuButton />]}>
        <img draggable={false} src={`${baseRoute}assets/images/skills.jpg`} />
